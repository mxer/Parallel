...
{
  /// This function locates and labels the clusters calculated on the slices.
  /// First we locate the clusters on each slice seperately and then we merge
  ///  the blobs of the slices of the current batch
  int label_count = K;
